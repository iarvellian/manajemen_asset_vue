<template>
    ...
    <div v-if="isLoading" id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Berita Acara Collapse Menu -->
            <!-- <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="login.html">BA Asset Masuk</a>
                        <a class="collapse-item" href="register.html">BA Asset Keluar</a>
                        <a class="collapse-item" href="forgot-password.html">BA Asset Dari Luar Kota</a>
                        <a class="collapse-item" href="404.html">BA Asset Rusak</a>
                    </div>
                </div>
            </li> -->
